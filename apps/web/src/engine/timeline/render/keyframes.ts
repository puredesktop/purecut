...
export function renderKeyframeTrack(
	...
	for (const keyframe of keyframes) {
		...
		ctx.strokeStyle = selected ? surface.colors.border.ring : surface.colors.ruler.text;
		ctx.fillStyle = selected ? surface.colors.border.ring : surface.colors.ruler.text;
