...
export function Inspector() {
  ...
  // Nothing picked at all — the panels below have nothing to say, so the
  // inspector says what the video is instead of standing empty.
  const nothingSelected = createMemo(() => selectionTarget() === "stage" && nodes().length === 0);
