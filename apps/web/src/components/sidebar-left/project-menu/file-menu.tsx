  ...
  return (
    <>
      <DropdownMenuGroup>
        ...
        <Show when={!import.meta.env.VITE_PURECUT}><DropdownMenuItem onSelect={handleDuplicateProject}>
          Duplicate project
      ...
      <DropdownMenuGroup>
        <DropdownMenuItem disabled={!!import.meta.env.VITE_PURECUT} onSelect={handleDeleteProject}>
          Delete project
        </DropdownMenuItem>
      </DropdownMenuGroup>
    </>
