...
export class AudioBus {
	...
	public sync(atTime?: number): void {
		if (atTime === undefined) this.gain.gain.value = this.getVolume();
		else this.gain.gain.setValueAtTime(this.getVolume(), atTime);
	}
	...
	public mute(atTime?: number): void {
		if (atTime === undefined) this.gain.gain.value = 0;
		else this.gain.gain.setValueAtTime(0, atTime);
	}
